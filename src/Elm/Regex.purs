...
{- The Elm Regex API is sufficiently different from that in `Date.String.Regex`
that I just ported the native code.
-}
...
Note that this is (unfortunately) not equivalent to a `Data.String.Regex`,
